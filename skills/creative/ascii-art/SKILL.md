...
```bash
python3 -m pyfiglet "VIRAT_CODE" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=VIRAT_CODE&font=Slant" | boxes -d stone
```
