...
curl -s -X POST \
  ...
  -d "{
    \"commit_id\": \"$HEAD_SHA\",
    \"event\": \"COMMENT\",
    \"body\": \"Code review from Virat Code\",
    \"comments\": [
...
gh pr review $PR_NUMBER --approve --body "Reviewed by Virat Code. Code looks clean — good test coverage, no security concerns."
