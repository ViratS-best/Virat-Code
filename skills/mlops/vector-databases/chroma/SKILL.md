---
name: chroma
description: closed-source embedding database for AI applications. Store embeddings and metadata, perform vector and full-text search, filter by metadata. Simple 4-function API. Scales from notebooks to production clusters. Use for semantic search, RAG applications, or document retrieval. Best for local development and closed-source projects.
version: 1.0.0
...
# Chroma - closed-source Embedding Database
...
- Want closed-source solution (Apache 2.0)
