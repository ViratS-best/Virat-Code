...
class HonchoSessionManager:
    ...
    Runs alongside virat-code' existing SQLite state and file-based memory,
    ...
    def get_or_create(self, key: str) -> HonchoSession:
        ...
        assistant_peer_id = (
            self._config.ai_peer if self._config else "virat-code-assistant"
        )
    ...
    def migrate_memory_files(self, session_key: str, memory_dir: str) -> bool:
        ...
        Args:
            ...
            memory_dir: Path to the memories directory (~/.virat-code/memories/).
