"""
Monkey patches for making Virat Code tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by virat_code_base_env.py).
