"""
Virat CodeAgentLoop -- Reusable Multi-Turn Agent Engine
...
# Resized at runtime by Virat CodeAgentBaseEnv.__init__ via resize_tool_pool().
...
def resize_tool_pool(max_workers: int):
    ...
    Called by Virat CodeAgentBaseEnv.__init__ based on config.tool_pool_size.
