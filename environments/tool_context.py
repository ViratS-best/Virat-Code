...
ALL Virat Code tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all Virat Code tools for a specific rollout.
    ...
    def upload_file(self, local_path: str, remote_path: str) -> Dict[str, Any]:
        ...
        if len(b64) <= chunk_size:
            ...
            tmp_b64 = "/tmp/_virat_code_upload.b64"
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any Virat Code tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("VIRAT_CODE_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("VIRAT_CODE_QUIET", None)
            else:
                os.environ["VIRAT_CODE_QUIET"] = _prev_quiet
