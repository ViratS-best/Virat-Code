...
Copies bundled skills from the repo's skills/ directory into ~/.virat-code/skills/
...
The manifest lives at ~/.virat-code/skills/.bundled_manifest.
"""
...
def _compute_relative_dest(skill_dir: Path, bundled_dir: Path) -> Path:
    ...
    e.g., bundled/skills/mlops/axolotl -> ~/.virat-code/skills/mlops/axolotl
    """
...
def sync_skills(quiet: bool = False) -> dict:
    """
    Sync bundled skills into ~/.virat-code/skills/ using the manifest.
...
if __name__ == "__main__":
    print("Syncing bundled skills into ~/.virat-code/skills/ ...")
