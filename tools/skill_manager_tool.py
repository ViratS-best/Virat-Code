...
~/.virat-code/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.virat-code/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    """
    Find a skill by name in ~/.virat-code/skills/.
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "New skills go to ~/.virat-code/skills/; existing skills can be modified wherever they live.\n\n"
