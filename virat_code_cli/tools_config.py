...
Saves per-platform tool configuration to ~/.virat-code/config.yaml under
...
# They're still in _VIRAT_CODE_CORE_TOOLS (available at runtime if enabled),
# but the setup checklist won't pre-select them for first-time users.
_DEFAULT_OFF_TOOLSETS = {"moa", "homeassistant", "rl"}

# Platform display config
PLATFORMS = {
    "cli":      {"label": "🖥️  CLI",       "default_toolset": "virat-code-cli"},
    "telegram": {"label": "📱 Telegram",   "default_toolset": "virat-code-telegram"},
    "discord":  {"label": "💬 Discord",    "default_toolset": "virat-code-discord"},
    "slack":    {"label": "💼 Slack",      "default_toolset": "virat-code-slack"},
    "whatsapp": {"label": "📱 WhatsApp",   "default_toolset": "virat-code-whatsapp"},
}
...
def tools_command(args=None, first_install: bool = False, config: dict = None):
    """Entry point for `virat-code tools` and `Virat-Code setup tools`.
    ...
    print()
    print(color("  Tool configuration saved to ~/.virat-code/config.yaml", Colors.DIM))
    print(color("  Changes take effect on next 'Virat-Code' or gateway restart.", Colors.DIM))
    print()
