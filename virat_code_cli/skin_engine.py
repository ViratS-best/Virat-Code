"""Virat-Code CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.virat-code/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Virat-Code"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Virat-Code "       # Response box header label
...
.. code-block:: python
    ...
    from virat_code_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Virat-Code"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.virat-code/skins/
...
Drop a YAML file in ``~/.virat-code/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    tool_prefix: str = "┊"
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces VIRAT_CODE_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces VIRAT_CODE_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Virat-Code — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Virat-Code",
            "welcome": "Welcome to Virat-Code! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Virat-Code ",
            "prompt_symbol": "❯ ",
...
def _skins_dir() -> Path:
    ...
    home = Path(os.getenv("VIRAT_CODE_HOME", Path.home() / ".virat-code"))
    return home / "skins"
