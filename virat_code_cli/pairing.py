...
Usage:
    Virat-Code pairing list              # Show all pending + approved users
    Virat-Code pairing approve <platform> <code>  # Approve a pairing code
    Virat-Code pairing revoke <platform> <user_id> # Revoke user access
    Virat-Code pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle Virat-Code pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: Virat-Code pairing {list|approve|revoke|clear-pending}")
        print("Run 'virat-code pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(f"  Run 'virat-code pairing list' to see pending codes.\n")
