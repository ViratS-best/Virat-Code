...
version: 0.2.0
author: Deniz Alagoz (gizdusum), enhanced by Virat Code
license: MIT
metadata:
  virat-code:
...
Helper script path: ~/.virat-code/skills/blockchain/solana/scripts/solana_client.py
...
python3 ~/.virat-code/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python3 ~/.virat-code/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python3 ~/.virat-code/skills/blockchain/solana/scripts/solana_client.py price BONK
python3 ~/.virat-code/skills/blockchain/solana/scripts/solana_client.py price JUP
python3 ~/.virat-code/skills/blockchain/solana/scripts/solana_client.py price SOL
python3 ~/.virat-code/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
