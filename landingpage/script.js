...
const PLATFORMS = {
    linux: {
        command: 'curl -fsSL https://raw.githubusercontent.com/NousResearch/Virat Code/main/scripts/install.sh | bash',
        prompt: '$',
...
const demoSequence = [
    ...
    { type: 'clear' },
    { type: 'prompt', text: '❯ ' },
    { type: 'type', text: 'Review the PR at NousResearch/Virat Code#42 and fix any issues', delay: 30 },
    { type: 'pause', ms: 600 },
    { type: 'output', lines: [
        '',
