...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the Virat-Code documentation based on your experience level and goals.'
---

# Learning Path

Virat-Code can do a lot — CLI assistant, Telegram/Discord bot, task automation, RL training, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.

:::tip Start Here
If you haven't installed Virat-Code yet, begin with the [Installation guide](/docs/getting-started/installation) and then run through the [Quickstart](/docs/getting-started/quickstart). Everything below assumes you have a working installation.
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything Virat-Code can do.
...
Use Virat-Code as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. Virat-Code can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy Virat-Code as a bot on your favorite messaging platform.
...
:::tip
Cron jobs let Virat-Code run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::

### "I want to build custom tools/skills"

Extend Virat-Code with your own tools and reusable skill packages.
...
Use reinforcement learning to fine-tune model behavior with Virat-Code's built-in RL training pipeline.
...
:::tip
RL training works best when you already understand the basics of how Virat-Code handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate Virat-Code into your own Python applications programmatically.
