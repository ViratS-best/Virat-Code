...
This tutorial walks you through setting up a Telegram bot powered by Virat Code that multiple team members can use. By the end, your team will have a shared AI assistant they can message for help with code, research, system administration, and anything else — secured with per-user authorization.
...
4. **Set a description** (optional but recommended):
   ...
   ```
   Team AI assistant powered by Virat Code. DM me for help with code, research, debugging, and more.
   ```
