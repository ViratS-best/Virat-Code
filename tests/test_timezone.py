"""
Tests for timezone support (virat_code_time module + integration points).
...
class TestViratCodeTimeNow:
    ...
    def test_valid_timezone_applies(self):
        ...
        os.environ["VIRAT_CODE_TIMEZONE"] = "Asia/Kolkata"
        result = virat_code_time.now()
    ...
    def test_utc_timezone(self):
        """UTC timezone works."""
        os.environ["VIRAT_CODE_TIMEZONE"] = "UTC"
        result = virat_code_time.now()
    ...
    def test_invalid_timezone_falls_back(self, caplog):
        ...
        os.environ["VIRAT_CODE_TIMEZONE"] = "Mars/Olympus_Mons"
        with caplog.at_level(logging.WARNING, logger="virat_code_time"):
            result = virat_code_time.now()
    ...
    def test_cache_invalidation(self):
        ...
        os.environ["VIRAT_CODE_TIMEZONE"] = "UTC"
        virat_code_time.reset_cache()
        r1 = virat_code_time.now()
        assert r1.utcoffset() == timedelta(0)

        os.environ["VIRAT_CODE_TIMEZONE"] = "Asia/Kolkata"
        virat_code_time.reset_cache()
        r2 = virat_code_time.now()
...
class TestGetTimezone:
    ...
    def test_returns_zoneinfo_for_valid(self):
        os.environ["VIRAT_CODE_TIMEZONE"] = "Europe/London"
        tz = virat_code_time.get_timezone()
    ...
    def test_returns_none_for_invalid(self):
        os.environ["VIRAT_CODE_TIMEZONE"] = "Not/A/Timezone"
        tz = virat_code_time.get_timezone()
        assert tz is None

    def test_get_timezone_name(self):
        os.environ["VIRAT_CODE_TIMEZONE"] = "Asia/Tokyo"
        assert virat_code_time.get_timezone_name() == "Asia/Tokyo"
...
class TestCodeExecutionTZ:
    ...
    def test_tz_injected_when_configured(self):
        """When VIRAT_CODE_TIMEZONE is set, child process sees TZ env var."""
        import json as _json
        os.environ["VIRAT_CODE_TIMEZONE"] = "Asia/Kolkata"
    ...
    def test_tz_not_injected_when_empty(self):
        """When VIRAT_CODE_TIMEZONE is not set, child process has no TZ."""
        import json as _json
        os.environ.pop("VIRAT_CODE_TIMEZONE", None)
    ...
    def test_virat_code_timezone_not_leaked_to_child(self):
        """VIRAT_CODE_TIMEZONE itself must NOT appear in child env (only TZ)."""
        import json as _json
        os.environ["VIRAT_CODE_TIMEZONE"] = "Asia/Kolkata"

        with patch("model_tools.handle_function_call", side_effect=self._mock_handle):
            result = _json.loads(self._execute_code(
                code='import os; print(os.environ.get("VIRAT_CODE_TIMEZONE", "NOT_SET"))',
...
class TestCronTimezone:
    ...
    def test_create_job_stores_tz_aware_timestamps(self, tmp_path, monkeypatch):
        ...
        os.environ["VIRAT_CODE_TIMEZONE"] = "US/Eastern"
        virat_code_time.reset_cache()
