...
class TestToolsetConsistency:
    ...
    def test_virat_code_platforms_share_core_tools(self):
        """All virat-code-* platform toolsets should have the same tools."""
        platforms = ["virat-code-cli", "virat-code-telegram", "virat-code-discord", "virat-code-whatsapp", "virat-code-slack", "virat-code-signal", "virat-code-homeassistant"]
