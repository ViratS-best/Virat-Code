...
SCRIPT_PATH = (
    ...
    / "openclaw-migration"
    / "scripts"
    / "openclaw_to_virat_code.py"
)


def load_module():
    spec = importlib.util.spec_from_file_location("openclaw_to_virat_code", SCRIPT_PATH)
...
"""
    ...
    assert "Tyler Williams > Active Projects: Virat Code" in entries
