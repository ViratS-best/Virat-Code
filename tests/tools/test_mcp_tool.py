...
class TestLoadMCPConfig:
    def test_no_config_returns_empty(self):
        ...
        with patch("virat_code_cli.config.load_config", return_value={"model": "test"}):
    ...
    def test_valid_config_parsed(self):
        ...
        with patch("virat_code_cli.config.load_config", return_value={"mcp_servers": servers}):
            from tools.mcp_tool import _load_mcp_config
            result = _load_mcp_config()
    ...
    def test_mcp_servers_not_dict_returns_empty(self):
        ...
        with patch("virat_code_cli.config.load_config", return_value={"mcp_servers": "invalid"}):
            from tools.mcp_tool import _load_mcp_config
            result = _load_mcp_config()
            assert result == {}
...
class TestSchemaConversion:
    def test_converts_mcp_tool_to_virat_code_schema(self):
...
class TestToolsetInjection:
    def test_mcp_tools_added_to_all_virat_code_toolsets(self):
        """Discovered MCP tools are dynamically injected into all virat-code-* toolsets."""
        from tools.mcp_tool import MCPServerTask
        ...
        fake_toolsets = {
            "virat-code-cli": {"tools": ["terminal"], "description": "CLI", "includes": []},
            "virat-code-telegram": {"tools": ["terminal"], "description": "TG", "includes": []},
            "virat-code-gateway": {"tools": [], "description": "GW", "includes": []},
            "non-virat-code": {"tools": [], "description": "other", "includes": []},
        }
        ...
        # All virat-code-* toolsets get injection
        assert "mcp_fs_list_files" in fake_toolsets["virat-code-cli"]["tools"]
        assert "mcp_fs_list_files" in fake_toolsets["virat-code-telegram"]["tools"]
        assert "mcp_fs_list_files" in fake_toolsets["virat-code-gateway"]["tools"]
        # Non-virat-code toolset should NOT get injection
        assert "mcp_fs_list_files" not in fake_toolsets["non-virat-code"]["tools"]
        # Original tools preserved
        assert "terminal" in fake_toolsets["virat-code-cli"]["tools"]
    ...
    def test_server_connection_failure_skipped(self):
        ...
        fake_toolsets = {
            "virat-code-cli": {"tools": [], "description": "CLI", "includes": []},
        }
