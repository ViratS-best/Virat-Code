...
class TestWriteDenyExactPaths:
    ...
    def test_virat_code_env(self):
        path = os.path.join(str(Path.home()), ".virat-code", ".env")
        assert _is_write_denied(path) is True
...
class TestWriteAllowed:
    ...
    def test_virat_code_config_not_env(self):
        path = os.path.join(str(Path.home()), ".virat-code", "config.yaml")
