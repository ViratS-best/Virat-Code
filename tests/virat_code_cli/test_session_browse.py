"""Tests for the interactive session browser (`virat-code sessions browse`).
...
from virat_code_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """virat-code sessions browse should be parseable."""
        from virat_code_cli.main import main as _main_entry
