"""Tests for virat_code_cli.skin_engine — the data-driven skin/theme system."""
...
def reset_skin_state():
    ...
    from virat_code_cli import skin_engine
...
class TestSkinConfig:
    def test_default_skin_has_required_fields(self):
        from virat_code_cli.skin_engine import load_skin
    ...
    def test_get_branding_with_fallback(self):
        from virat_code_cli.skin_engine import load_skin
        skin = load_skin("default")
        assert skin.get_branding("agent_name") == "Virat-Code"
...
class TestBuiltinSkins:
    ...
    def test_all_builtin_skins_have_complete_colors(self):
        from virat_code_cli.skin_engine import _BUILTIN_SKINS, _build_skin_config
...
class TestSkinManagement:
    def test_set_active_skin(self):
        from virat_code_cli.skin_engine import set_active_skin, get_active_skin, get_active_skin_name
    ...
    def test_list_skins_includes_builtins(self):
        from virat_code_cli.skin_engine import list_skins
        skins = list_skins()
    ...
    def test_init_skin_from_config(self):
        from virat_code_cli.skin_engine import init_skin_from_config, get_active_skin_name
...
class TestUserSkins:
    def test_load_user_skin_from_yaml(self, tmp_path, monkeypatch):
        from virat_code_cli.skin_engine import load_skin, _skins_dir
        ...
        # Patch skins dir
        monkeypatch.setattr("virat_code_cli.skin_engine._skins_dir", lambda: skins_dir)
...
class TestDisplayIntegration:
    ...
    def test_get_skin_tool_prefix_custom(self):
        from virat_code_cli.skin_engine import set_active_skin
        from agent.display import get_skin_tool_prefix
