...
class TestHasAnyProviderConfigured:
    ...
    def test_glm_key_counts(self, monkeypatch, tmp_path):
        from virat_code_cli import config as config_module
        monkeypatch.setenv("GLM_API_KEY", "test-key")
        virat_code_home = tmp_path / ".virat-code"
        virat_code_home.mkdir()
        monkeypatch.setattr(config_module, "get_env_path", lambda: virat_code_home / ".env")
        monkeypatch.setattr(config_module, "get_virat_code_home", lambda: virat_code_home)
        from virat_code_cli.main import _has_any_provider_configured
